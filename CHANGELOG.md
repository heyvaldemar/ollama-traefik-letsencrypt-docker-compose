...
- **`ollama/ollama:0.34.3` moved to `ollama/ollama:0.34.4`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`ollama/ollama:0.34.2` moved to `ollama/ollama:0.34.3`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`ollama/ollama:0.34.0` moved to `ollama/ollama:0.34.1`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
